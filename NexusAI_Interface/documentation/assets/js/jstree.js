...
!(function (a) {
  ...
  if (!a.jstree) {
    ...
    !j &&
      ...
      (a.jstree = { version: "3.3.9", defaults: { plugins: [] }, plugins: {}, path: h && -1 !== h.indexOf("/") ? h.replace(/\/[^\/]+$/, "") : "", idregex: /[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g, root: "#" }),
      ...
      (a.jstree.core.prototype = {
          ...
          this.element
            ...
            .on(
              ...
              a.proxy(function (b, c) {
                c.status &&
                  (c.node.id !== a.jstree.root || this._data.core.loaded || ((this._data.core.loaded = !0), this._firstChild(this.get_container_ul()[0]) && this.element.attr("aria-activedescendant", this._firstChild(this.get_container_ul()[0]).id), this.trigger("loaded")),
              ...
              ? d.url
                ? ((d = a.extend(!0, {}, d)),
                  ...
                  a
                    ...
                    .fail(
                      a.proxy(function (a) {
                        (this._data.core.last_error = { error: "ajax", plugin: "core", id: "core_04", reason: "Could not load node", data: JSON.stringify({ id: b.id, xhr: a }) }), c.call(this, !1), this.settings.core.error.call(this, this._data.core.last_error);
                      }, this)
                    ))
                : ((e = a.isArray(d) ? a.extend(!0, [], d) : a.isPlainObject(d) ? a.extend(!0, {}, d) : d),
                  b.id === a.jstree.root
                    ...
                    : ((this._data.core.last_error = { error: "nodata", plugin: "core", id: "core_05", reason: "Could not load node", data: JSON.stringify({ id: b.id }) }), this.settings.core.error.call(this, this._data.core.last_error), c.call(this, !1)))
              : "string" == typeof d
              ? b.id === a.jstree.root
                ? this._append_html_data(b, a(a.parseHTML(d)).filter(f), function (a) {
                    c.call(this, a);
                  })
                : ((this._data.core.last_error = { error: "nodata", plugin: "core", id: "core_06", reason: "Could not load node", data: JSON.stringify({ id: b.id }) }), this.settings.core.error.call(this, this._data.core.last_error), c.call(this, !1))
              : c.call(this, !1)
            : b.id === a.jstree.root
        ...
        _append_json_data: function (b, c, d, e) {
          if (null !== this.element) {
            ...
            var f = null,
              ...
              i = function (a, b) {
                ...
                var c = a.dat,
                  ...
                  s = function (a, c, d) {
                    ...
                    var e = a.id.toString(),
                      ...
                      j,
                      k,
                      m = { id: e, text: a.text || "", icon: a.icon !== b ? a.icon : !0, parent: c, parents: d, children: a.children || [], children_d: a.children_d || [], data: a.data, state: {}, li_attr: { id: !1 }, a_attr: { href: "#" }, original: !1 };
                ...
                if (c.length && c[0].id !== b && c[0].parent !== b) {
                  ...
                  for (p = 0, q = c.length; q > p; p++) l[c[p].parent.toString()] ? (l[c[p].parent.toString()].children.push(c[p].id.toString()), m.children_d.push(c[p].id.toString())) : "undefined" != typeof h && ((h._data.core.last_error = { error: "parse", plugin: "core", id: "core_07", reason: "Node with invalid parent", data: JSON.stringify({ id: c[p].id.toString(), parent: c[p].parent.toString() }) }), h.settings.core.error.call(h, h._data.core.last_error));
            ...
            if (this.settings.core.worker && window.Blob && window.URL && window.Worker)
              try {
                null === this._wrk && (this._wrk = window.URL.createObjectURL(new window.Blob(["self.onmessage = " + i.toString()], { type: "text/javascript" }))),
        ...
        _parse_model_from_flat_json: function (a, c, d) {
          ...
          var e = a.id.toString(),
            ...
            j,
            k,
            l = { id: e, text: a.text || "", icon: a.icon !== b ? a.icon : !0, parent: c, parents: d, children: a.children || [], children_d: a.children_d || [], data: a.data, state: {}, li_attr: { id: !1 }, a_attr: { href: "#" }, original: !1 };
        ...
        redraw_node: function (b, c, d, e) {
          ...
          if (((c = c || 0 === f.children.length), (b = i.querySelector ? this.element[0].querySelector("#" + (-1 !== "0123456789".indexOf(f.id[0]) ? "\\3" + f.id[0] + " " + f.id.substr(1).replace(a.jstree.idregex, "\\$&") : f.id.replace(a.jstree.idregex, "\\$&"))) : i.getElementById(f.id))))
            (b = a(b)), d || ((g = b.parent().parent()[0]), g === this.element[0] && (g = null), (h = b.index())), c || !f.children.length || b.children(".jstree-children").length || (c = !0), c || (j = b.children(".jstree-children")[0]), (q = b.children(".jstree-anchor")[0] === i.activeElement), b.remove();
          else if (((c = !0), !d)) {
          ...
          if (
            ...
            ((f.icon && f.icon !== !0) || f.icon === !1) &&
              (f.icon === !1
                ...
                : ((b.childNodes[1].childNodes[0].style.backgroundImage = 'url("' + f.icon + '")'), (b.childNodes[1].childNodes[0].style.backgroundPosition = "center center"), (b.childNodes[1].childNodes[0].style.backgroundSize = "auto"), (b.childNodes[1].childNodes[0].className += " jstree-themeicon-custom"))),
        ...
        deselect_node: function (b, c, d) {
          ...
          return (
            ...
            b && b.id !== a.jstree.root
              ? ((g = this.get_node(b, !0)), void (b.state.selected && ((b.state.selected = !1), (this._data.core.selected = a.vakata.array_remove_item(this._data.core.selected, b.id)), g.length && g.attr("aria-selected", !1).children(".jstree-anchor").removeClass("jstree-clicked"), this.trigger("deselect_node", { node: b, selected: this._data.core.selected, event: d }), c || this.trigger("changed", { action: "deselect_node", node: b, selected: this._data.core.selected, event: d }))))
              : !1
          );
        },
        ...
        get_state: function () {
          var b = { core: { open: [], loaded: [], scroll: { left: this.element.scrollLeft(), top: this.element.scrollTop() }, selected: [] } },
            c;
        ...
        set_state: function (c, d) {
          if (c) {
            if ((c.core && c.core.selected && c.core.initial_selection === b && (c.core.initial_selection = this._data.core.selected.concat([]).sort().join(",")), c.core)) {
              ...
              if (c.core.loaded)
                return (
                  this.settings.core.loaded_state && a.isArray(c.core.loaded) && c.core.loaded.length
        ...
        refresh: function (b, c) {
          ...
          b || (this.element.html("<ul class='" + d + "' role='group'><li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("Loading ...") + "</a></li></ul>"), this.element.attr("aria-activedescendant", "j" + this._id + "_loading")),
        ...
        get_json: function (b, c, d) {
          ...
          c && c.flat && !d && (d = []);
          var e = { id: b.id, text: b.text, icon: this.get_icon(b), li_attr: a.extend(!0, {}, b.li_attr), a_attr: a.extend(!0, {}, b.a_attr), state: {}, data: c && c.no_data ? !1 : a.extend(!0, a.isArray(b.data) ? [] : {}, b.data) },
            f,
            g;
        ...
        check: function (b, c, d, e, f) {
          ...
          if ("move_node" === b || "copy_node" === b) {
            if (!((f && f.is_multi) || "move_node" !== b || a.inArray(c.id, d.children) !== e)) return (this._data.core.last_error = { error: "check", plugin: "core", id: "core_08", reason: "Moving node to its current position", data: JSON.stringify({ chk: b, pos: e, obj: c && c.id ? c.id : !1, par: d && d.id ? d.id : !1 }) }), !1;
            if (!((f && f.is_multi) || (c.id !== d.id && ("move_node" !== b || a.inArray(c.id, d.children) !== e) && -1 === a.inArray(d.id, c.children_d)))) return (this._data.core.last_error = { error: "check", plugin: "core", id: "core_01", reason: "Moving parent inside child", data: JSON.stringify({ chk: b, pos: e, obj: c && c.id ? c.id : !1, par: d && d.id ? d.id : !1 }) }), !1;
          }
          return (
            g && g.data && (g = g.data),
            g && g.functions && (g.functions[b] === !1 || g.functions[b] === !0)
              ? (g.functions[b] === !1 && (this._data.core.last_error = { error: "check", plugin: "core", id: "core_02", reason: "Node data prevents function: " + b, data: JSON.stringify({ chk: b, pos: e, obj: c && c.id ? c.id : !1, par: d && d.id ? d.id : !1 }) }), g.functions[b])
              : h === !1 || (a.isFunction(h) && h.call(this, b, c, d, e, f) === !1) || (h && h[b] === !1)
              ? ((this._data.core.last_error = { error: "check", plugin: "core", id: "core_03", reason: "User config for core.check_callback prevents function: " + b, data: JSON.stringify({ chk: b, pos: e, obj: c && c.id ? c.id : !1, par: d && d.id ? d.id : !1 }) }), !1)
              : !0
          );
        },
        last_error: function () {
        ...
        move_node: function (c, d, e, f, g, h, i) {
          ...
          if ((e > n.children.length && (e = n.children.length), !this.check("move_node", c, n, e, { core: !0, origin: i, is_multi: o && o._id && o._id !== this._id, is_foreign: !o || !o._id }))) return this.settings.core.error.call(this, this._data.core.last_error), !1;
          if (c.parent === n.id) {
        ...
        copy_node: function (c, d, e, f, g, h, i) {
          ...
          if ((e > r.children.length && (e = r.children.length), !this.check("copy_node", c, r, e, { core: !0, origin: i, is_multi: s && s._id && s._id !== this._id, is_foreign: !s || !s._id }))) return this.settings.core.error.call(this, this._data.core.last_error), !1;
          ...
          return (b = this.get_node(b))
            ? this.check("edit", b, this.get_parent(b))
              ? ((n = b),
                ...
                (h = a("<span>")),
                (j = c),
                (k = a("<div />", { css: { position: "absolute", top: "-200px", left: e ? "0px" : "-1000px", visibility: "hidden" } }).appendTo(i.body)),
                (l = a("<input />", {
                  value: j,
                ...
                (m = { fontFamily: g.css("fontFamily") || "", fontSize: g.css("fontSize") || "", fontWeight: g.css("fontWeight") || "", fontStyle: g.css("fontStyle") || "", fontStretch: g.css("fontStretch") || "", fontVariant: g.css("fontVariant") || "", letterSpacing: g.css("letterSpacing") || "", wordSpacing: g.css("wordSpacing") || "" }),
                        ...
                        (i = this._model.data[e.parents[g]]),
                          ...
                          i &&
                            ...
                            i
                              ...
                              .children(".jstree-anchor")
                              .removeClass(k ? "jstree-clicked" : "jstree-checked");
                      l = a.vakata.array_filter(l, function (a) {
              ...
              a.each(b, function (b, d) {
                return d
                  ? (c.items.push(d),
                    ...
                    (f = !1),
                    (e += "<li class='" + (d._class || "") + (d._disabled === !0 || (a.isFunction(d._disabled) && d._disabled({ item: d, reference: c.reference, element: c.element })) ? " vakata-contextmenu-disabled " : "") + "' " + (d.shortcut ? " data-shortcut='" + d.shortcut + "' " : "") + ">"),
                    (e += "<a href='#' rel='" + (c.items.length - 1) + "' " + (d.title ? "title='" + d.title + "'" : "") + ">"),
                    a.vakata.context.settings.icons && ((e += "<i "), d.icon && (e += -1 !== d.icon.indexOf("/") || -1 !== d.icon.indexOf(".") ? " style='background:url(\"" + d.icon + "\") center center no-repeat' " : " class='" + d.icon + "' "), (e += "></i><span class='vakata-contextmenu-sep'>&#160;</span>")),
                    (e += (a.isFunction(d.label) ? d.label({ item: b, reference: c.reference, element: c.element }) : d.label) + (d.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + d.shortcut + '">' + (d.shortcut_label || "") + "</span>" : "") + "</a>"),
                    d.submenu && ((g = a.vakata.context._parse(d.submenu, !0)), g && (e += g)),
                    (e += "</li>"),
                    void (d.separator_after && ((e += "<li class='vakata-context-separator'><a href='#' " + (a.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;</a></li>"), (f = !0))))
                  : !0;
              }),
          ...
          show: function (d, e, f) {
            ...
            d && !f && a(d).data("vakata_contextmenu") && (f = a(d).data("vakata_contextmenu")),
              ...
              c.items.length &&
                ...
                b && ((j -= h.outerWidth() - a(d).outerWidth()), j < a(window).scrollLeft() + 20 && (j = a(window).scrollLeft() + 20)),
                j + l + 20 > n && (j = n - (l + 20)),
                k + m + 20 > o && (k = o - (m + 20)),
                c.element.css({ left: j, top: k }).show().find("a").first().focus().parent().addClass("vakata-context-hover"),
                (c.is_visible = !0),
    ...
    (a.jstree.plugins.dnd = function (b, c) {
            ...
            this.element.on(
              ...
              a.proxy(function (b) {
                ...
                if ((this.settings.core.force_text && (e = a.vakata.html.escape(e)), c && c.id && c.id !== a.jstree.root && (1 === b.which || "touchstart" === b.type || "dragstart" === b.type) && (this.settings.dnd.is_draggable === !0 || (a.isFunction(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, d > 1 ? this.get_top_selected(!0) : [c], b))))) {
                  if (((m = { jstree: !0, origin: this, obj: this.get_node(c, !0), nodes: d > 1 ? this.get_top_selected() : [c.id] }), (n = b.currentTarget), !this.settings.dnd.use_html5))
                    return this.element.trigger("mousedown.jstree"), a.vakata.dnd.start(b, m, '<div id="jstree-dnd" class="jstree-' + this.get_theme() + " jstree-" + this.get_theme() + "-" + this.get_theme_variant() + " " + (this.settings.core.themes.responsive ? " jstree-dnd-responsive" : "") + '"><i class="jstree-icon jstree-er"></i>' + e + '<ins class="jstree-copy" style="display:none;">+</ins></div>');
                  a.vakata.dnd._trigger("start", b, { helper: a(), element: n, data: m });
                }
              }, this)
            ),
            this.settings.dnd.use_html5 &&
              this.element
                .on("dragover.jstree", function (b) {
                  return b.preventDefault(), a.vakata.dnd._trigger("move", b, { helper: a(), element: n, data: m }), !1;
                })
                .on(
                  "drop.jstree",
                  a.proxy(function (b) {
                    return b.preventDefault(), a.vakata.dnd._trigger("stop", b, { helper: a(), element: n, data: m }), !1;
                  }, this)
                );
        }),
      ...
      a(function () {
        ...
        a(i)
          .on("dragover.vakata.jstree", function (b) {
            n && a.vakata.dnd._trigger("move", b, { helper: a(), element: n, data: m });
          })
          .on("drop.vakata.jstree", function (b) {
            n && (a.vakata.dnd._trigger("stop", b, { helper: a(), element: n, data: m }), (n = null), (m = null));
          })
            ...
            if ((f && (!i.event || "dragover" !== i.event.type || j) && clearTimeout(f), i && i.data && i.data.jstree && (!i.event.target.id || "jstree-marker" !== i.event.target.id))) {
              ...
              if (k && k._data && k._data.dnd)
                if (
                      ...
                      a.each(u, function (b, e) {
                        ...
                        for (v = !0, w = 0, x = i.data.nodes.length; x > w; w++)
                          if (
                            ...
                            (z = t),
                            "move_node" === y && "a" === e && i.data.origin && i.data.origin === k && s === k.get_parent(i.data.nodes[w]) && ((A = k.get_node(s)), z > a.inArray(i.data.nodes[w], A.children) && (z -= 1)),
                            (v = v && ((k && k.settings && k.settings.dnd && k.settings.dnd.check_while_dragging === !1) || k.check(y, i.data.origin && i.data.origin !== k ? i.data.origin.get_node(i.data.nodes[w]) : i.data.nodes[w], s, z, { dnd: !0, ref: k.get_node(l.parent()), pos: e, origin: i.data.origin, is_multi: i.data.origin && i.data.origin !== k, is_foreign: !i.data.origin }))),
                            !v)
                          ) {
                  ...
                  for (v = !0, w = 0, x = i.data.nodes.length; x > w; w++)
                    if (((v = v && k.check(i.data.origin && (i.data.origin.settings.dnd.always_copy || (i.data.origin.settings.dnd.copy && (i.event.metaKey || i.event.ctrlKey))) ? "copy_node" : "move_node", i.data.origin && i.data.origin !== k ? i.data.origin.get_node(i.data.nodes[w]) : i.data.nodes[w], a.jstree.root, "last", { dnd: !0, ref: k.get_node(a.jstree.root), pos: "i", origin: i.data.origin, is_multi: i.data.origin && i.data.origin !== k, is_foreign: !i.data.origin })), !v)) break;
                  if (v) return (c = { ins: k, par: a.jstree.root, pos: "last" }), g.hide(), i.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"), void (i.event.originalEvent && i.event.originalEvent.dataTransfer && (i.event.originalEvent.dataTransfer.dropEffect = D ? "copy" : "move"));
                }
      ...
      (function (a) {
        ...
        a.vakata.dnd = {
          settings: { scroll_speed: 10, scroll_proximity: 20, helper_left: 5, helper_top: 10, threshold: 5, threshold_touch: 10 },
          ...
          _clean: function () {
            c.helper && c.helper.remove(), c.scroll_i && (clearInterval(c.scroll_i), (c.scroll_i = !1)), (c = { element: !1, target: !1, is_down: !1, is_drag: !1, helper: !1, helper_w: 0, data: !1, init_x: 0, init_y: 0, scroll_l: 0, scroll_t: 0, scroll_e: !1, scroll_i: !1, is_touch: !1 }), (n = null), a(i).off("mousemove.vakata.jstree touchmove.vakata.jstree", a.vakata.dnd.drag), a(i).off("mouseup.vakata.jstree touchend.vakata.jstree", a.vakata.dnd.stop);
          },
          _scroll: function (b) {
          ...
          drag: function (b) {
            if (("touchmove" === b.type && b.originalEvent && b.originalEvent.changedTouches && b.originalEvent.changedTouches[0] && ((b.pageX = b.originalEvent.changedTouches[0].pageX), (b.pageY = b.originalEvent.changedTouches[0].pageY), (b.target = i.elementFromPoint(b.originalEvent.changedTouches[0].pageX - window.pageXOffset, b.originalEvent.changedTouches[0].pageY - window.pageYOffset))), c.is_down)) {
              ...
              return (
                ...
                a(a(b.target).parentsUntil("body").addBack().get().reverse())
                  ...
                  .each(function () {
                    var d = a(this),
                      e = d.offset();
                    return (
                      this.scrollHeight > this.offsetHeight && (e.top + d.height() - b.pageY < a.vakata.dnd.settings.scroll_proximity && (c.scroll_t = 1), b.pageY - e.top < a.vakata.dnd.settings.scroll_proximity && (c.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth && (e.left + d.width() - b.pageX < a.vakata.dnd.settings.scroll_proximity && (c.scroll_l = 1), b.pageX - e.left < a.vakata.dnd.settings.scroll_proximity && (c.scroll_l = -1)),
                ...
                c.helper && ((m = parseInt(b.pageY + a.vakata.dnd.settings.helper_top, 10)), (n = parseInt(b.pageX + a.vakata.dnd.settings.helper_left, 10)), f && m + 25 > f && (m = f - 50), h && n + c.helper_w > h && (n = h - (c.helper_w + 2)), c.helper.css({ left: n + "px", top: m + "px" })),
    ...
    var o = !1;
    (a.jstree.defaults.state = { key: "jstree", events: "changed.jstree open_node.jstree close_node.jstree check_node.jstree uncheck_node.jstree", ttl: !1, filter: !1, preserve_loaded: !1 }),
      ...
      (a.jstree.plugins.types = function (c, d) {
        (this.init = function (c, e) {
          ...
          (this.get_json = function (b, c, e) {
            ...
            if (j === !1) return !1;
            if (a.isArray(j)) for (f = 0, g = j.length; g > f; f++) (j[f].type = j[f].id && h[j[f].id] && h[j[f].id].type ? h[j[f].id].type : "default"), c && c.no_id && (delete j[f].id, j[f].li_attr && j[f].li_attr.id && delete j[f].li_attr.id, j[f].a_attr && j[f].a_attr.id && delete j[f].a_attr.id);
            ...
            switch (((i = i && i._model && i._model.data ? i._model.data : null), c)) {
              ...
              case "copy_node":
                if ("move_node" !== c || -1 === a.inArray(e.id, f.children)) {
                  if (((j = this.get_rules(f)), j.max_children !== b && -1 !== j.max_children && j.max_children === f.children.length)) return (this._data.core.last_error = { error: "check", plugin: "types", id: "types_01", reason: "max_children prevents function: " + c, data: JSON.stringify({ chk: c, pos: g, obj: e && e.id ? e.id : !1, par: f && f.id ? f.id : !1 }) }), !1;
                  if (j.valid_children !== b && -1 !== j.valid_children && -1 === a.inArray(e.type || "default", j.valid_children)) return (this._data.core.last_error = { error: "check", plugin: "types", id: "types_02", reason: "valid_children prevents function: " + c, data: JSON.stringify({ chk: c, pos: g, obj: e && e.id ? e.id : !1, par: f && f.id ? f.id : !1 }) }), !1;
                  ...
                  (0 >= k || k === b) && (k = 1);
                  do {
                    if (j.max_depth !== b && -1 !== j.max_depth && j.max_depth < k) return (this._data.core.last_error = { error: "check", plugin: "types", id: "types_03", reason: "max_depth prevents function: " + c, data: JSON.stringify({ chk: c, pos: g, obj: e && e.id ? e.id : !1, par: f && f.id ? f.id : !1 }) }), !1;
        ...
        (this.check = function (b, c, e, f, g) {
          ...
          switch ((j || (h = h.toLowerCase()), k && (h = h.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), b)) {
            case "delete_node":
              return !0;
            case "rename_node":
              return (o = c.text || ""), j || (o = o.toLowerCase()), k && (o = o.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), (m = -1 === a.inArray(h, i) || (c.text && o === h)), m || (this._data.core.last_error = { error: "check", plugin: "unique", id: "unique_01", reason: "Child with name " + h + " already exists. Preventing: " + b, data: JSON.stringify({ chk: b, pos: f, obj: c && c.id ? c.id : !1, par: e && e.id ? e.id : !1 }) }), m;
            case "create_node":
              return (m = -1 === a.inArray(h, i)), m || (this._data.core.last_error = { error: "check", plugin: "unique", id: "unique_04", reason: "Child with name " + h + " already exists. Preventing: " + b, data: JSON.stringify({ chk: b, pos: f, obj: c && c.id ? c.id : !1, par: e && e.id ? e.id : !1 }) }), m;
            case "copy_node":
              return (m = -1 === a.inArray(h, i)), m || (this._data.core.last_error = { error: "check", plugin: "unique", id: "unique_02", reason: "Child with name " + h + " already exists. Preventing: " + b, data: JSON.stringify({ chk: b, pos: f, obj: c && c.id ? c.id : !1, par: e && e.id ? e.id : !1 }) }), m;
            case "move_node":
              return (m = (c.parent === e.id && (!g || !g.is_multi)) || -1 === a.inArray(h, i)), m || (this._data.core.last_error = { error: "check", plugin: "unique", id: "unique_03", reason: "Child with name " + h + " already exists. Preventing: " + b, data: JSON.stringify({ chk: b, pos: f, obj: c && c.id ? c.id : !1, par: e && e.id ? e.id : !1 }) }), m;
          }
          return !0;
        }),
    ...
    if (
      ...
      try {
        window.customElements.define("vakata-jstree", function () {}, { prototype: q });
      } catch (r) {}
    }
  }
});
