@echo off
echo =====================================================================
echo     AIArm WITH INNER LIFE - 100%% Local AI with Continuous Thought
echo =====================================================================
echo.
...
start "AIArm Inner Life" cmd /c "python D:\AIArm\InnerLife\inner_life_processor.py"
echo Inner Life Processor started in a separate window.
echo.

echo STEP 6: Starting server on port 45678 with continuous thought processing...
echo.
echo *******************************************************************
echo *                                                                 *
...
echo *                                                                 *
echo * You can monitor Nexus's thoughts in the separate window.        *
echo *                                                                 *
echo *******************************************************************
echo.
