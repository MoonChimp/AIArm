@echo off
echo =====================================================================
echo          AIArm LOCAL OLLAMA LAUNCHER - With Conversation Memory
echo =====================================================================
echo.
...
echo STEP 5: Checking Memory Directory...
if not exist "D:\AIArm\Memory" (
    echo Creating Memory Directory for conversation history...
    mkdir "D:\AIArm\Memory"
) else (
    echo Memory Directory exists. Conversation history will be preserved.
)

echo STEP 6: Starting server on port 45678 with 100%% local Ollama models...
echo Enhanced system with CONVERSATION MEMORY - your chat history will be maintained!
